    ...
    <div class="container-fluid">
    	<div class="col-md-12">
            <div class="card card-plain">
                ...
                <div class="col-md-12">
                    <form action="{{ route('admin.post.store') }}" method="post" id="form-add-edit">
                    {{ csrf_field() }}
                            ...
                            <div class="col-md-8">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control tinymce" name="content" placeholder="Content" rows="10"></textarea>
                                    </div>
...
<script src="{{ url('backend/js/pages/post-add-edit.js') }}"></script>
@endpush