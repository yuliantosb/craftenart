            ...
            <div class="card card-plain">
                <div class="header">
                    <div class="pull-left">
                        ...
                        <p class="widget">Display all widget list</p>
                    </div>
                    <div class="pull-right">
                        <a href="{{ route('admin.widget.create') }}" class="btn btn-primary">Create New</a>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="content table-responsive table-full-width">
                        <table class="table table-striped" id="table-widget">
                            <thead>
                                <tr>
...
<script src="{{ url('backend/js/pages/widget.js') }}"></script>
@endpush